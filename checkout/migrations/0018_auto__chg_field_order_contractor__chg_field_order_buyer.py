...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.contractor'
        db.alter_column(u'checkout_order', 'contractor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User']))

        # Changing field 'Order.buyer'
        db.alter_column(u'checkout_order', 'buyer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User']))

    def backwards(self, orm):

        # Changing field 'Order.contractor'
        db.alter_column(u'checkout_order', 'contractor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Order.buyer'
        db.alter_column(u'checkout_order', 'buyer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
