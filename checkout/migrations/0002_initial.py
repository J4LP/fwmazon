...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'checkout_order', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buyer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', to=orm['auth.User'])),
            ('total_price', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=15, decimal_places=2, blank=True)),
            ('elements_price', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=15, decimal_places=2, blank=True)),
            ('shipping_fee', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=15, decimal_places=2, blank=True)),
        ...
        db.create_table(u'checkout_orderelement', (
            ...
            ('doctrine_fit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.DoctrineFit'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve.InvType'])),
        ))
