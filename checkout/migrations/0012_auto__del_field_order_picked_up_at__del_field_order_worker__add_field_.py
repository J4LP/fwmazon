...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.picked_up_at'
        db.delete_column(u'checkout_order', 'picked_up_at')

        # Deleting field 'Order.worker'
        db.delete_column(u'checkout_order', 'worker_id')

        # Adding field 'Order.contractor'
        db.add_column(u'checkout_order', 'contractor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders_contracted', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Order.contracted_at'
        db.add_column(u'checkout_order', 'contracted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.picked_up_at'
        db.add_column(u'checkout_order', 'picked_up_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.worker'
        db.add_column(u'checkout_order', 'worker',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='work_orders', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Order.contractor'
        db.delete_column(u'checkout_order', 'contractor_id')

        # Deleting field 'Order.contracted_at'
        db.delete_column(u'checkout_order', 'contracted_at')
    ...
    models = {
        ...
        u'checkout.order': {
            ...
            'contractor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders_contracted'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'shipping_fee': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '15', 'decimal_places': '2', 'blank': 'True'}),
            'to_be_fitted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'total_price': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '15', 'decimal_places': '2', 'blank': 'True'}),
