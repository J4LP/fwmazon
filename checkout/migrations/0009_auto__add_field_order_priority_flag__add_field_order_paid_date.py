...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.priority_flag'
        db.add_column(u'checkout_order', 'priority_flag',
    ...
    def backwards(self, orm):
        # Deleting field 'Order.priority_flag'
        db.delete_column(u'checkout_order', 'priority_flag')
