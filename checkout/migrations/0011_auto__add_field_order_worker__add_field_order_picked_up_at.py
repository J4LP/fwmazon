...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'checkout.order': {
            ...
            'picked_up_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'worker': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'work_orders'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
