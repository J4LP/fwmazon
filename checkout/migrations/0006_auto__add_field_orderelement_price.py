...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderElement.price'
        db.add_column(u'checkout_orderelement', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=15, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderElement.price'
        db.delete_column(u'checkout_orderelement', 'price')
