...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'checkout_payment', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment', to=orm['checkout.Order'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('transaction_id', self.gf('django.db.models.fields.IntegerField')(max_length=15)),
            ('character_id', self.gf('django.db.models.fields.IntegerField')(max_length=15)),
    ...
    models = {
        ...
        u'checkout.payment': {
            ...
            'character_id': ('django.db.models.fields.IntegerField', [], {'max_length': '15'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment'", 'to': u"orm['checkout.Order']"}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'transaction_id': ('django.db.models.fields.IntegerField', [], {'max_length': '15'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
