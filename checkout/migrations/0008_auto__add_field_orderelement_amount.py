...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderElement.amount'
        db.add_column(u'checkout_orderelement', 'amount',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderElement.amount'
        db.delete_column(u'checkout_orderelement', 'amount')
