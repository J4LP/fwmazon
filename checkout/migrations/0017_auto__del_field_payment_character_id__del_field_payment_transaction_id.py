...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Payment.transaction_id'
        db.delete_column(u'checkout_payment', 'transaction_id')

        # Adding field 'Payment.transaction'
        db.add_column(u'checkout_payment', 'transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve.CorpWalletJournalEntry'], null=True),
                      keep_default=False)


        # Changing field 'Payment.key'
        db.alter_column(u'checkout_payment', 'key', self.gf('django.db.models.fields.CharField')(max_length=35))
        # Deleting field 'Order.paid'
        db.delete_column(u'checkout_order', 'paid')

        # Deleting field 'Order.paid_date'
        db.delete_column(u'checkout_order', 'paid_date')


    def backwards(self, orm):
        # Adding field 'Payment.character_id'
        db.add_column(u'checkout_payment', 'character_id',
                      self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'Payment.transaction_id'
        db.add_column(u'checkout_payment', 'transaction_id',
                      self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True),
                      keep_default=False)

        # Deleting field 'Payment.transaction'
        db.delete_column(u'checkout_payment', 'transaction_id')


        # Changing field 'Payment.key'
        db.alter_column(u'checkout_payment', 'key', self.gf('django.db.models.fields.CharField')(max_length=64))
        # Adding field 'Order.paid'
        db.add_column(u'checkout_order', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.paid_date'
        db.add_column(u'checkout_order', 'paid_date',
    ...
    models = {
        ...
        u'checkout.payment': {
            ...
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['eve.CorpWalletJournalEntry']", 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
