...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingDestination.system'
        db.add_column(u'checkout_shippingdestination', 'system',
                      self.gf('django.db.models.fields.CharField')(default='B-DBYQ', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingDestination.system'
        db.delete_column(u'checkout_shippingdestination', 'system')
