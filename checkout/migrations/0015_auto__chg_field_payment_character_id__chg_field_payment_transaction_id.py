...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.character_id'
        db.alter_column(u'checkout_payment', 'character_id', self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True))

        # Changing field 'Payment.transaction_id'
        db.alter_column(u'checkout_payment', 'transaction_id', self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'Payment.character_id'
        db.alter_column(u'checkout_payment', 'character_id', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=15))

        # Changing field 'Payment.transaction_id'
        db.alter_column(u'checkout_payment', 'transaction_id', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=15))
    ...
    models = {
        ...
        u'checkout.payment': {
            ...
            'character_id': ('django.db.models.fields.IntegerField', [], {'max_length': '15', 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment'", 'to': u"orm['checkout.Order']"}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'transaction_id': ('django.db.models.fields.IntegerField', [], {'max_length': '15', 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
