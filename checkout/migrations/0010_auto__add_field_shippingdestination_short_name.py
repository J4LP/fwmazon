...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingDestination.short_name'
        db.add_column(u'checkout_shippingdestination', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='Foobar', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingDestination.short_name'
        db.delete_column(u'checkout_shippingdestination', 'short_name')
