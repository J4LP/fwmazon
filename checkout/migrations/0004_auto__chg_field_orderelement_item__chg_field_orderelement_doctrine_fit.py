...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderElement.item'
        db.alter_column(u'checkout_orderelement', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve.InvType'], null=True))

        # Changing field 'OrderElement.doctrine_fit'
        db.alter_column(u'checkout_orderelement', 'doctrine_fit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.DoctrineFit'], null=True))

    def backwards(self, orm):

        # Changing field 'OrderElement.item'
        db.alter_column(u'checkout_orderelement', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['eve.InvType']))

        # Changing field 'OrderElement.doctrine_fit'
        db.alter_column(u'checkout_orderelement', 'doctrine_fit_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['shop.DoctrineFit']))
    ...
    models = {
        ...
        u'checkout.order': {
            ...
            'volume': ('django.db.models.fields.DecimalField', [], {'default': '1.0', 'max_digits': '15', 'decimal_places': '2', 'blank': 'True'})
        },
