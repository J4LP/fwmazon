...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'checkout_payment', 'order_id')

        # Adding field 'Order.payment'
        db.add_column(u'checkout_order', 'payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='order', to=orm['checkout.Payment']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'checkout_order', 'payment_id')
