...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DoctrineFit', fields ['creator']
        db.delete_unique(u'shop_doctrinefit', ['creator_id'])


        # Changing field 'DoctrineFit.creator'
        db.alter_column(u'shop_doctrinefit', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'DoctrineFit.creator'
        db.alter_column(u'shop_doctrinefit', 'creator_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'DoctrineFit', fields ['creator']
        db.create_unique(u'shop_doctrinefit', ['creator_id'])
    ...
    models = {
        ...
        u'shop.doctrinefit': {
            ...
            'bought': ('django.db.models.fields.IntegerField', [], {}),
