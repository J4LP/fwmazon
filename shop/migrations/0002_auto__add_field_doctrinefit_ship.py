...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DoctrineFit.ship'
        db.add_column(u'shop_doctrinefit', 'ship',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['eve.InvType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DoctrineFit.ship'
        db.delete_column(u'shop_doctrinefit', 'ship_id')
