...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DoctrineFit.created_at'
        db.alter_column(u'shop_doctrinefit', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'DoctrineFit.updated_at'
        db.alter_column(u'shop_doctrinefit', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'DoctrineFit.created_at'
        db.alter_column(u'shop_doctrinefit', 'created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'DoctrineFit.updated_at'
        db.alter_column(u'shop_doctrinefit', 'updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True))
