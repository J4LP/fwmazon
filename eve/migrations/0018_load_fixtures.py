...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        subprocess.Popen(['git', 'clone', 'https://github.com/J4LP/fwmazon-fixtures.git'], stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()
        call_command('loaddata', 'fwmazon-fixtures/invcategory.json')
        call_command('loaddata', 'fwmazon-fixtures/invgroup.json')
        call_command('loaddata', 'fwmazon-fixtures/invmarketgroup.json')
        call_command('loaddata', 'fwmazon-fixtures/invtype.json')
        subprocess.Popen(['rm', '-rf', 'fwmazon-fixtures'], stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()
