...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'eve_itemprice', (
            ...
            ('item_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='price', to=orm['eve.InvType'])),
    ...
    models = {
        ...
        u'eve.itemprice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'price'", 'to': u"orm['eve.InvType']"}),
