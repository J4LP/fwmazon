...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'eve_apikey', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.User'], unique=True, null=True))

        # Changing field 'Character.user'
        db.alter_column(u'eve_character', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.User'], unique=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Character.user'
        db.alter_column(u'eve_character', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
