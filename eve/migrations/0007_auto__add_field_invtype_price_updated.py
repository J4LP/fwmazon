...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvType.price_updated'
        db.add_column(u'eve_invtype', 'price_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvType.price_updated'
        db.delete_column(u'eve_invtype', 'price_updated')
    ...
    models = {
        ...
        u'eve.invtype': {
            ...
            'price_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
